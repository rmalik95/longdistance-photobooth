...
export default function CameraStage({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative flex-1 flex flex-col items-center justify-center gap-3 bg-[#FDFBF7]"
        data-testid="partner-status-panel"
      >
        ...
        {partnerState === "ready" && phase !== "captured_wait" && (
          <>
        ...
        {phase === "captured_wait" && (
          <>
            <Clock className="text-[#E07A5F] animate-pulse-soft" size={40} strokeWidth={2.5} />
            <p className="font-body font-semibold text-[#1A1A19] text-sm sm:text-base text-center px-4">
              {waitingForPartnerShot
