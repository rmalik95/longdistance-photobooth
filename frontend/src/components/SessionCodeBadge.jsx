...
export default function SessionCodeBadge({ code }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-full border border-ink/15 bg-white/60 px-4 py-2.5">
      <span
        className="font-mono font-semibold text-base tracking-[0.2em] text-ink"
      ...
      <button
        ...
        className="flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.1em] text-signal hover:text-signal-dark transition-colors cursor-pointer"
      >
